...
class FrontSwitcherSheet extends StatefulWidget {
  ...
  @override
  State<FrontSwitcherSheet> createState() =>
      _FrontSwitcherSheetState();
}

class _FrontSwitcherSheetState
    extends State<FrontSwitcherSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        // Always-visible search bar in the actual sheet imported by Home.
        Padding(
          padding: const EdgeInsets.fromLTRB(
            18,
            6,
